...
class SupabaseCloudContent extends StatelessWidget {
  const SupabaseCloudContent({
    super.key,
    required this.state,
  ...
  Widget build(BuildContext context) {
    ...
    final supabase = localState is SupabaseState ? localState : null;
    final authenticated = supabase?.userName != null;
    final active = supabase != null && supabase.isActive;
    return Column(
