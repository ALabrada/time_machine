...
class GoogleDriveCloudContent extends StatelessWidget {
  const GoogleDriveCloudContent({
    super.key,
    required this.state,
  ...
  Widget build(BuildContext context) {
    ...
    final drive = localState is GoogleDriveState ? localState : null;
    final authenticated = drive != null && drive.isConnected;
    final active = drive != null && drive.isActive;
    return Column(
