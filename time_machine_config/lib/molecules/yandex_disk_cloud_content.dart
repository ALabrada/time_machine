...
class YandexDiskCloudContent extends StatelessWidget {
  const YandexDiskCloudContent({
    super.key,
    required this.state,
  ...
  Widget build(BuildContext context) {
    ...
    final yandex = localState is YandexDiskState ? localState : null;
    final authenticated = yandex?.accountEmail != null;
    final active = yandex != null && yandex.isActive;
    return Column(
          ...
          child: Column(
            ...
            children: [
              ListTile(
                ...
                subtitle: yandex?.accountEmail != null
                    ? Text(yandex!.accountEmail!)
                    : null,
                trailing: Text(
                  authenticated
