...
#include <vol_spotter_linux/vol_spotter_plugin.h>
...
void fl_register_plugins(FlPluginRegistry* registry) {
  ...
  g_autoptr(FlPluginRegistrar) vol_spotter_linux_registrar =
      fl_plugin_registry_get_registrar_for_plugin(registry, "VolSpotterPlugin");
  vol_spotter_plugin_register_with_registrar(vol_spotter_linux_registrar);
